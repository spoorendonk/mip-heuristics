...
// A recognized non-empty preset overrides all five flags; an empty or
...
// and runs the fixed FJ -> FPR -> LocalMIP -> Scylla chain with either
// deterministic or opportunistic parallelism.  Returns true if the model
